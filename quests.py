    ...
    def quest_b5(self):
        def labyrinth(response=None):
            ...
            if response == '1':
                ...
                while correct < 3.:
                    ...
                    if correct >= 3.:
                        self.parent.text.system(text=""" You approach the end of the Maze. Lucky you :) The are no many people to do it\n Those that loat, died in the Labyrinth\n""")
        ...
        def find_place_to_sleep(response=None):
            ...
            if response == '1' or response == '2':
                ...
                self.parent.text.system(text=""" You sleep on the streets. You lose 20HP but you also find 20 coins\n""")
                self.parent.myPlayer.HP -= 20
                self.parent.myPlayer.cash += 20
            elif response == '4':
                self.parent.text.system(
        ...
        def courrier_task(response=None):
            if not response:
                ...
                self.parent.text.npc(text=f"Excesue me but today I am really busy. Could you please help me with something?\n", begin_txt='Vaegirn the Weak')
            ...
            if response == '1':
                ...
                self.parent.text.npc(text=f"Thank you my friend. And remember the password - Cunidas Koehern. My brother will ask for it\n", begin_txt='Vaegirn the Weak')
